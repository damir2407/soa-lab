...
public class SpaceMarineController {
    ...
    public List<SpaceMarine> searchByNameContains(@RequestParam String substring) {
        return service.searchByNameContains(substring);
    }

    @PostMapping("/search-by-name-start")
    public List<SpaceMarine> searchByNameStartsWith(@RequestParam String substring) {
        return service.searchByNameStartsWith(substring);
    }
